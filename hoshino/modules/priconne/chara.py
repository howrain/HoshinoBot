...
def add_nickname(id_, nickname):
    check = _pcr_data.chara_master.check_nickname(id_, nickname)
    if not check:
        _pcr_data.chara_master.add_nickname(id_, nickname)
        return True
    else:
        return False
    pass
...
def remove_nickname(id_, nickname):
    remove_name = _pcr_data.chara_master.remove_nickname(id_, nickname)
    return remove_name


def get_nicknames(id_):
    nicknames = _pcr_data.chara_master.get_nicknames(id_)
    return nicknames


def default_nickname(id_, nickname):
    result = _pcr_data.chara_master.default_nickname(id_, nickname)
    return result
